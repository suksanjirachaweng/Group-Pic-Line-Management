 ...
 * needing an account. View + export only, no editing or messaging (those stay admin-gated on
 * the tagging page itself). Scoped by photoId alone since it doesn't need a university-scoped
 * admin session to resolve access. No live registrant/reference matching needed here — each
 * tag's stored `matchSource` (set at tagging/import time) is all validateTags() needs.
 */
